...
public class Statistics {
    ...
    /**
     * Returns a map with the total price spent on each 'beer' product, if used in an order
     * NOTE: Products not sold will not show up in the map
     */
    ...
    /**
     * Returns a map with the total price of all sales for each category used in an order
     * NOTE: Categories with no sale will not show up
     */
    ...
    /**
     * Returns a map with the total price of all sales made by each user
     * NOTE: users with no sales will not show up
     */
